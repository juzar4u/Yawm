...
{ 
    function addCombo(editor, comboName, styleType, lang, entries, defaultLabel, styleDefinition, order)
	{
		...
		editor.ui.addRichCombo( comboName,
		{
				...
				init : function()
				{
				    ...
				    this.startGroup('line-height'); // this is the combo options group text
	...
	CKEDITOR.plugins.add('lineheight',
	{
		...
		{
			var config = editor.config;
			addCombo(editor, 'lineheight', 'size', editor.lang, config.lineheight_sizes, config.lineheight_defaultLabel, config.lineheight_style, 49);
		}
	});
})();
...
CKEDITOR.config.lineheight_defaultLabel = 'normal';
